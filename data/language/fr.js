...
var language = [
	...
	{ id: "healthbardescription", string: "Ici, vous pouvez changer les paramètres de la barre de vie." },
	{ id: "manabardescription", string: "Ici, vous pouvez changer les paramètres de la barre de mana." },
	{ id: "bufftimersdescription", string: "Ici, vous pouvez changer les paramètres de vos buffs personnels." },
	...
	{ id: "partydescription", string: "Ici, vous pouvez changer les paramètres de vos cooldown de groupe." },
	...
	{ id: "durationcolor", string: "Couleur de la Durée" },
	{ id: "cooldowncolor", string: "Couleur du Cooldown" },
	{ id: "durationoutlinecolor", string: "Couleur du contour de la Durée" },
	{ id: "cooldownoutlinecolor", string: "Couleur du contour du Cooldown" },
	{ id: "durationbold", string: "Texte de la Durée en gras" },
	{ id: "cooldownbold", string: "Texte du Cooldown en gras" },
	{ id: "durationoutline", string: "Contour de la Durée" },
	{ id: "cooldownoutline", string: "Contour du Cooldown" },
	{ id: "includealliance", string: "Inclure l'alliance dans les membres du groupe" },
	{ id: "orderbypartymember", string: "Ordre par membre du groupe" },
	{ id: "order", string: "Ordre" },
	{ id: "partyorder", string: "Ordre du groupe (drag and drop)" },
	// SKINS
	...
	{ id: "gld", string: "Gladiateur" },
	{ id: "war", string: "Guerrier" },
	{ id: "mrd", string: "Maraudeur" },
	{ id: "drk", string: "Chevalier noir" },
	{ id: "gnb", string: "Pistosabreur" },
	{ id: "whm", string: "Mage Blanc" },
	{ id: "cnj", string: "Élémentaliste" },
	{ id: "sch", string: "Érudit" },
	{ id: "ast", string: "Astromancien" },
	{ id: "mnk", string: "Moine" },
	{ id: "pgl", string: "Pugiliste" },
	{ id: "drg", string: "Chevalier dragon" },
	{ id: "lnc", string: "Maître d'hast" },
	{ id: "nin", string: "Ninja" },
	{ id: "rog", string: "Surineur" },
	{ id: "sam", string: "Samouraï" },
	{ id: "brd", string: "Barde" },
	{ id: "arc", string: "Archer" },
	{ id: "mch", string: "Machiniste" },
	{ id: "dnc", string: "Danseur" },
	{ id: "blm", string: "Mage Noir" },
	{ id: "thm", string: "Occultiste" },
	{ id: "smn", string: "Invocateur" },
	{ id: "acn", string: "Arcaniste" },
	{ id: "rdm", string: "Mage Rouge" },
	{ id: "blu", string: "Mage Bleu" },
	// CONTEXT MENU
